...
void benchmarkPartA()
{
    ...
    printf("Priority Queue: \tCustom Array Priority Queue");
    printf("\n===== Initialization =====\n");
    ...
    for (int i = 100; i <= 2000; i += 100)
    {
        ...
        for (int j = 0; j < 5; j ++)
        {
            ...
            for (int k = 1; k <= i; k ++)
            {
                ...
                ArrayPathSearch(g, k, visited, dist, parent, &keyComparisons);
